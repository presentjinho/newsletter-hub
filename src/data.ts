...
export const rawNewsletters: Partial<Newsletter>[] = [
  ...
  { id: 'outstand', name: '아웃스탠딩', category: '비즈니스', frequency: '평일', frequencyGroup: 'daily', description: '스타트업과 IT 비즈니스의 맥락을 깊게 읽습니다.', url: 'https://outstanding.kr/', siteUrl: 'https://outstanding.kr/', daysSince: 0, typical: '평일', status: 'alive', interests: ['AI', '커리어', '재테크'], trust: ['공식 링크 확인', '유료 포함'] },
  ...
  // beletter 도메인 소멸 — 목록에서 제거 (캐릿 careet 유지)
